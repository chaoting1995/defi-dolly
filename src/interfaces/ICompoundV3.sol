...
interface ICompoundV3 {
    ...
    function collateralBalanceOf(address account, address asset) external view returns (uint128); // account total supply
    function borrowBalanceOf(address account) external view returns (uint256); // account total borrow
